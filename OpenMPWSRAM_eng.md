...
I had a really bad experience when I used self-made memory in OpenMPW. Apparently, if you use memory generated by OpenRAM, you will be happy, so I will describe the results of my various trial and error attempts.
...
As for the delay in reading data, you should wait a little because the SRAM code says something like †FIXME: This delay is arbitrary†.
